...
public abstract class GraphicalObject
{
    ...
    public float distance(GraphicalObject bullet,GraphicalObject ennemy){
        float distanceX = ennemy.getPosX() - bullet.getPosX();
        float distanceY = ennemy.getPosY() - bullet.getPosY();
        float distanceZ = ennemy.getPosZ() - bullet.getPosZ();
